        ...
        <div className="container" style={{ marginTop: "20px" }}>
            <div className="row h-100">
                <div className="col">
                    ...
                    <p>Please tell us how you are feeling today by choosing one of the options below:</p>
                </div>
            </div>
            ...
            { needhelp === 1 ? (
                <div className="row" style={{ marginTop: "10px" }}>
                    <div className="col">
                        <p>Sorry that you are not feeling well today. Would you like to talk about your feelings with a counselor?</p>
